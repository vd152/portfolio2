          ...
          <div className="row">
            ...
            <div className="col-lg-8 pt-4 pt-lg-0 content">
              ...
              <p className="mt-4 mb-5">
                ...
                <br />
                I am currently studying Computer Science Engineering and have
                always had a keen interest in programming and development. Since
                the last two years, I've been really crazy about web or full
